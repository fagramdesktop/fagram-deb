...
usage() {
    ...
    echo "Example: $0 owner/repo 'fagram-v*.tar.zst'"
    exit 1
}
...
#REPOSITORY=$1
#FILE_PATTERN=$2
REPOSITORY='fagramdesktop/fadesktop'
FILE_PATTERN='fagram-*.tar.zst'
